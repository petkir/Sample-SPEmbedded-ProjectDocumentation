...
export interface IFolderEXProps extends IFolderProps {
    reloadParent: () => void;
}

export function Folder(props: IFolderEXProps) {
                ...
                <div className="ml-2 inline">
                    <button type="submit" title="delete"
                        onClick={(e) => {
                            ...
                            if (confirm("Are you sure you want to delete this ara?")) {
                                deleteFolder();
                            }
                        }}
